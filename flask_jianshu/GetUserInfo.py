...
class GetUserInfo:
    ...
    def __init__(self,slug):
        ...
        AJAX_HEADERS = {"Referer": "http//:www.jianshu.com/u/{}".format(self.slug),
                        "X-PJAX": "true"}
    ...
    def get_user_timeline(self,last_time='',max_id=None,page=1):
        if max_id == None:
            url = 'https://www.jianshu.com/users/{}/timeline'.format(self.slug)
        else:
            url = 'https://www.jianshu.com/users/{0}/timeline?max_id={1}&page={2}'.format(self.slug,max_id,page)
    ...
    def get_user_info(self):
        url = 'https://www.jianshu.com/u/{}'.format(self.slug)
